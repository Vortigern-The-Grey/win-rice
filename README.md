...
```
{"taskbarItemWidth":0,"minimumTaskbarItemWidth":0,"maximumTaskbarItemWidth":114,"runningIndicatorStyle":"fullWidth","progressIndicatorStyle":"fullWidth","fontSize":20,"leftAndRightPaddingSize":15,"spaceBetweenIconAndLabel":15,"labelForSingleItem":"%name%","labelForMultipleItems":"[%amount%] %name%"}
```
